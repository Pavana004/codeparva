    ...
    <>
      <div className='main mt-5 p-5'>
        <div className='container'>
          <div className='row'>
            <div className='col '>
              <h2 className='head'>We do take in pets if you can't take care of them !</h2>
              <br />
              ...
              <div className='b' >
                <button type='button' className='btn bg-secondary ' onClick={() => setOpen2(true)}>Give Away</button>
              </div>
              <Modal isOpen={open2} onRequestClose={() => setOpen2(false)}>
                ...
                <div className='fromfield'>
                  ...
                  >
                    {({ errors, touched }) => (
                      <Form>
                        <h5 className='headtitle'>What pet do you want to give away ?</h5>
                        <br />
